...
from implementation.src.implementation.gmail_client import GmailClient
...
def test_connect_success(mock_client) -> None:
...
def test_connect_failure(mock_client) -> None:
...
def test_login_success(mock_client) -> None:
...
def test_login_failure(mock_client) -> None:
...
def test_authenticate_success(mock_client) -> None:
...
def test_logout(mock_client) -> None:
...
def test_get_emails_with_query(mock_client) -> None:
...
def test_get_emails_empty_result(mock_client) -> None:
...
def test_get_email_content(mock_client) -> None:
...
def test_send_email_success(mock_client) -> None:
...
def test_send_email_failure(mock_client) -> None:
...
def test_detects_spam_email(mock_client) -> None:
...
def test_unsubscribe_from_email_sender_success(mock_client) -> None:
